...
Ce dossier fait partie de la documentation du **Nutria Agent**. Il contient les fichiers de configuration pour le système de refus du chatbot, permettant de personnaliser les réponses selon les cas d'usage.
