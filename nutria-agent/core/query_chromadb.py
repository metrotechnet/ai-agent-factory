    ...
    if collection is None:
        try:
            ...
            if not os.path.exists(chroma_path):
                ...
                print(f"Make sure knowledge base is indexed first.")
                return None
            ...
            try:
                ...
                print(f"Collection 'gdrive_documents' loaded with {collection.count()} documents")
            except:
                print(f"Creating new gdrive_documents collection...")
