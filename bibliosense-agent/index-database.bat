...
setlocal
REM ==================================================
REM Rebuild local Bibliosense knowledge base into ChromaDB
REM Usage: index-database.bat [project_name] [collection_name]
REM Example: index-database.bat bibliosense gdrive_documents
REM ==================================================

set "PROJECT_NAME=%~1"
if "%PROJECT_NAME%"=="" set "PROJECT_NAME=bibliosense"
