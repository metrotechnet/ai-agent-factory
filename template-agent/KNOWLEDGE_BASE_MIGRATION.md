...
The template-agent project uses a modular knowledge base system. This guide documents the structure and how to work with it.
...
All data from the old structure has been automatically migrated to `knowledge-base/nutria/`.
...
4. **Prompts Configuration**
   - Moved `prompts.json` from `config/` to `knowledge-base/nutria/`
...
# Add documents
cp *.txt knowledge-base\medical-kb\extracted_texts\
...
Copy-Item knowledge-base\nutria\prompts.json knowledge-base\medical-kb\prompts.json

# Edit the prompts to match the KB's domain
notepad knowledge-base\medical-kb\prompts.json
```
...
- ✅ All 843 documents from old `chroma_db/` are now in `knowledge-base/nutria/chroma_db/`
- ✅ All transcripts moved to `knowledge-base/nutria/transcripts/`
- ✅ All documents moved to `knowledge-base/nutria/documents/`
- ✅ All extracted texts moved to `knowledge-base/nutria/extracted_texts/`
...
Expected output:
- ✅ 4 folders in `knowledge-base/nutria/`
...
- **knowledge-base/README.md**: Complete knowledge base documentation
...
2. Review `knowledge-base/README.md`
