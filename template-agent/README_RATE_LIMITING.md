...
Ce document décrit la configuration de la limitation de débit (rate limiting) pour le projet **Template Agent**. Il explique comment protéger l'application contre les abus et les attaques, et détaille les paramètres utilisés dans ce projet.
