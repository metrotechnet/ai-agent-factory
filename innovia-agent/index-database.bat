...
setlocal
REM ==================================================
REM Rebuild local Innovia knowledge base into ChromaDB
REM Usage: index-database.bat [project_name] [collection_name]
REM Example: index-database.bat innovia cctt
REM ==================================================

set "PROJECT_NAME=%~1"
if "%PROJECT_NAME%"=="" set "PROJECT_NAME=innovia"

set "COLLECTION_NAME=%~2"
if "%COLLECTION_NAME%"=="" set "COLLECTION_NAME=cctt"
